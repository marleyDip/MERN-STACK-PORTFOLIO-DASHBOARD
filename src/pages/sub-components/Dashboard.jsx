          ...
          <div className="grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-2">
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
              <Card className="sm:col-span-2">
                ...
                <CardFooter>
                  <Link
                    ...
                    target="_blank"
                  >
                    <Button className="hover:text-base">Visit Portfolio</Button>
                  </Link>
                </CardFooter>
              </Card>
              ...
              <Card className="flex flex-col justify-center">
                ...
                <CardFooter>
                  <Button className="hover:text-base" onClick={gotoMangeSkills}>
                    Manage Skill
                  </Button>
                </CardFooter>
              </Card>
            ...
            <Tabs>
              <TabsContent>
                <Card>
                  <CardHeader className="px-7 bg-lime-500">
            ...
            <Tabs>
              <TabsContent>
                <Card>
                  <CardHeader className="px-7 gap-3 bg-sky-500">
                    <CardTitle>Skills</CardTitle>
                  </CardHeader>
            ...
            <Tabs>
              <TabsContent className="grid min-[1050px]:grid-cols-2 gap-4">
                <Card>
                  <CardHeader className="px-7 bg-green-500">
                ...
                <Card>
                  <CardHeader className="px-7 flex items-center justify-between flex-row bg-orange-500">
                    <CardTitle>Timeline</CardTitle>
                    <Button
                      onClick={gotoMangeTimeline}
                      className="w-fit hover:text-base"
                    >
                      Manage Timeline
                    </Button>
                  </CardHeader>
