              ...
              <div className="mt-10 flex flex-col gap-5 bg-slate-100 p-1">
                ...
                <div className="w-full sm:col-span-4">
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 bg-white">
                      <textarea
                        className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 h-28 resize-none"
          ...
          <div className="mt-6 flex items-center justify-end gap-x-4">
            {!loading ? (
              <Button
                ...
                className="w-full hover:bg-lime-600 hover:text-base"
              >
                Add Timeline
              </Button>
            ) : (
